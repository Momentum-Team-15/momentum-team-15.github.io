...
On Thursday we'll be covering a way to add routing to our application with ReactRouter. If you want to get a head start, [there's a brand new React Router tutorial](https://reactrouter.com/en/main/start/tutorial). Note that this tutorial uses a build tool called Vite instead of Create-React-App -- they do similiar things. You can use Vite along with the tutorial or just substitute Create-React-App.
...
- [Example Dog Adoption](https://github.com/Momentum-Team-15/example-react-dog-adoption)
